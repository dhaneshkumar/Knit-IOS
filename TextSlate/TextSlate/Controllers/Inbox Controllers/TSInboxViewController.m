...
#warning Need to complete here
        ...
        UIAlertView *errorDialog = [[UIAlertView alloc] initWithTitle:@"Text Slate" message:@"Error occurred in fetching messages" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil];
        [errorDialog show];
    }];
}
