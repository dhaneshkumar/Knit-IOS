...
@interface TSNewInboxViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, NSCacheDelegate, QLPreviewControllerDataSource, UIDocumentInteractionControllerDelegate>
